...
- Prüfer outer self-consistency 复核已完成：default/low-T/high-T/stiff 四点、z=5/7 均两次迭代收敛，`DN_gw` 最大相对差 `3.44e-9`，无 `DN_eff` guard crossing。仍只覆盖固定 8 频率，reheating edge/Sobol/full-grid 尚未认证。
