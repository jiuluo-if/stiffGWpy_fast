...
| P3.4 | `stiffgwpy_fast/cobaya/likelihoods`, docs | Bundled observational data provenance/license/checksum is incomplete. | Add a data manifest with source, version, license, checksum and regeneration/acquisition method. | Every bundled observational file has a traceable manifest entry. |
